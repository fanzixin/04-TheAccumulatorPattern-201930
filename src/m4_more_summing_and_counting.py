...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 0
    answer = count_cosines_from(5, 100, 2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 42
    answer = count_cosines_from(5, 100, 0.2)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 3.10404  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(5, 100)
